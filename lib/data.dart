...
List<Feed> feeds = [
  Feed(
      Idarwiis,
      '#FlutterFriday\nis\nhere.\n\nRight pointing backhand indexYou can specify whether your Flutter project uses Swift, Objective C, Kotlin, or Java by specifying:\n\n"--ios-language objc" or "--android-language java" when you type "flutter create".\n\nElectric light bulbBy default new projects use Kotlin and Swift.'
      ,
      null,
      15,
      2,
